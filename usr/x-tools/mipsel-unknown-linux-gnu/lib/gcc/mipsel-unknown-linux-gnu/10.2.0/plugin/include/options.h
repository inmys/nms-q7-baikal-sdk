...
enum opt_code
{
  ...
  OPT_list = 1598,                           /* -list */
  OPT_mabi_ = 1599,                          /* -mabi= */
  OPT_mabicalls = 1600,                      /* -mabicalls */
  OPT_mabs_ = 1601,                          /* -mabs= */
  OPT_mandroid = 1602,                       /* -mandroid */
  OPT_march_ = 1603,                         /* -march= */
  OPT_mbionic = 1604,                        /* -mbionic */
  OPT_mbranch_cost_ = 1605,                  /* -mbranch-cost= */
  OPT_mbranch_likely = 1606,                 /* -mbranch-likely */
  OPT_mcheck_zero_division = 1607,           /* -mcheck-zero-division */
  OPT_mcode_readable_ = 1608,                /* -mcode-readable= */
  OPT_mcompact_branches_ = 1609,             /* -mcompact-branches= */
  OPT_mcrc = 1610,                           /* -mcrc */
  OPT_mdebug = 1611,                         /* -mdebug */
  OPT_mdebugd = 1612,                        /* -mdebugd */
  OPT_mdivide_breaks = 1613,                 /* -mdivide-breaks */
  OPT_mdivide_traps = 1614,                  /* -mdivide-traps */
  OPT_mdmx = 1615,                           /* -mdmx */
  OPT_mdouble_float = 1616,                  /* -mdouble-float */
  OPT_mdsp = 1617,                           /* -mdsp */
  OPT_mdspr2 = 1618,                         /* -mdspr2 */
  OPT_meb = 1619,                            /* -meb */
  OPT_mel = 1620,                            /* -mel */
  OPT_membedded_data = 1621,                 /* -membedded-data */
  OPT_meva = 1622,                           /* -meva */
  OPT_mexplicit_relocs = 1623,               /* -mexplicit-relocs */
  OPT_mextern_sdata = 1624,                  /* -mextern-sdata */
  OPT_mfix_24k = 1625,                       /* -mfix-24k */
  OPT_mfix_r10000 = 1626,                    /* -mfix-r10000 */
  OPT_mfix_r4000 = 1627,                     /* -mfix-r4000 */
  OPT_mfix_r4400 = 1628,                     /* -mfix-r4400 */
  OPT_mfix_r5900 = 1629,                     /* -mfix-r5900 */
  OPT_mfix_rm7000 = 1630,                    /* -mfix-rm7000 */
  OPT_mfix_sb1 = 1631,                       /* -mfix-sb1 */
  OPT_mfix_vr4120 = 1632,                    /* -mfix-vr4120 */
  OPT_mfix_vr4130 = 1633,                    /* -mfix-vr4130 */
  OPT_mfix4300 = 1634,                       /* -mfix4300 */
  OPT_mflip_mips16 = 1635,                   /* -mflip-mips16 */
  OPT_mflush_func_ = 1636,                   /* -mflush-func= */
  OPT_mfp_exceptions = 1637,                 /* -mfp-exceptions */
  OPT_mfp32 = 1638,                          /* -mfp32 */
  OPT_mfp64 = 1639,                          /* -mfp64 */
  OPT_mfpxx = 1640,                          /* -mfpxx */
  OPT_mframe_header_opt = 1641,              /* -mframe-header-opt */
  /* OPT_mfused_madd = 1642, */              /* -mfused-madd */
  OPT_mginv = 1643,                          /* -mginv */
  OPT_mglibc = 1644,                         /* -mglibc */
  OPT_mgp32 = 1645,                          /* -mgp32 */
  OPT_mgp64 = 1646,                          /* -mgp64 */
  OPT_mgpopt = 1647,                         /* -mgpopt */
  OPT_mhard_float = 1648,                    /* -mhard-float */
  OPT_mimadd = 1649,                         /* -mimadd */
  OPT_minterlink_compressed = 1650,          /* -minterlink-compressed */
  OPT_minterlink_mips16 = 1651,              /* -minterlink-mips16 */
  OPT_mips = 1652,                           /* -mips */
  OPT_mips16 = 1653,                         /* -mips16 */
  OPT_mips3d = 1654,                         /* -mips3d */
  OPT_mllsc = 1655,                          /* -mllsc */
  OPT_mload_store_pairs = 1656,              /* -mload-store-pairs */
  OPT_mlocal_sdata = 1657,                   /* -mlocal-sdata */
  OPT_mlong_calls = 1658,                    /* -mlong-calls */
  OPT_mlong32 = 1659,                        /* -mlong32 */
  OPT_mlong64 = 1660,                        /* -mlong64 */
  OPT_mloongson_ext = 1661,                  /* -mloongson-ext */
  OPT_mloongson_ext2 = 1662,                 /* -mloongson-ext2 */
  OPT_mloongson_mmi = 1663,                  /* -mloongson-mmi */
  OPT_mlra = 1664,                           /* -mlra */
  OPT_mlxc1_sxc1 = 1665,                     /* -mlxc1-sxc1 */
  OPT_mmad = 1666,                           /* -mmad */
  OPT_mmadd4 = 1667,                         /* -mmadd4 */
  OPT_mmcount_ra_address = 1668,             /* -mmcount-ra-address */
  OPT_mmcu = 1669,                           /* -mmcu */
  OPT_mmemcpy = 1670,                        /* -mmemcpy */
  OPT_mmicromips = 1671,                     /* -mmicromips */
  OPT_mmsa = 1672,                           /* -mmsa */
  OPT_mmt = 1673,                            /* -mmt */
  OPT_mmusl = 1674,                          /* -mmusl */
  OPT_mnan_ = 1675,                          /* -mnan= */
  OPT_mno_float = 1676,                      /* -mno-float */
  OPT_mno_flush_func = 1677,                 /* -mno-flush-func */
  OPT_mno_mdmx = 1678,                       /* -mno-mdmx */
  OPT_mno_mips16 = 1679,                     /* -mno-mips16 */
  OPT_mno_mips3d = 1680,                     /* -mno-mips3d */
  OPT_modd_spreg = 1681,                     /* -modd-spreg */
  OPT_mpaired_single = 1682,                 /* -mpaired-single */
  OPT_mplt = 1683,                           /* -mplt */
  OPT_mr10k_cache_barrier_ = 1684,           /* -mr10k-cache-barrier= */
  OPT_mrelax_pic_calls = 1685,               /* -mrelax-pic-calls */
  OPT_mshared = 1686,                        /* -mshared */
  OPT_msingle_float = 1687,                  /* -msingle-float */
  OPT_msmartmips = 1688,                     /* -msmartmips */
  OPT_msoft_float = 1689,                    /* -msoft-float */
  OPT_msplit_addresses = 1690,               /* -msplit-addresses */
  OPT_msym32 = 1691,                         /* -msym32 */
  OPT_msynci = 1692,                         /* -msynci */
  OPT_mtune_ = 1693,                         /* -mtune= */
  OPT_muclibc = 1694,                        /* -muclibc */
  OPT_muninit_const_in_rodata = 1695,        /* -muninit-const-in-rodata */
  OPT_mvirt = 1696,                          /* -mvirt */
  OPT_mvr4130_align = 1697,                  /* -mvr4130-align */
  OPT_mxgot = 1698,                          /* -mxgot */
  OPT_mxpa = 1699,                           /* -mxpa */
  OPT_n = 1700,                              /* -n */
  ...
  OPT_pie = 1721,                            /* -pie */
  OPT_pipe = 1722,                           /* -pipe */
  OPT_posix = 1723,                          /* -posix */
  OPT_print_file_name_ = 1724,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1725,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1726,          /* -print-multi-directory */
  OPT_print_multi_lib = 1727,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1728,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1729,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1730,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1731,               /* -print-prog-name= */
  OPT_print_search_dirs = 1732,              /* -print-search-dirs */
  OPT_print_sysroot = 1733,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1734,   /* -print-sysroot-headers-suffix */
  OPT_print_value = 1735,                    /* -print-value */
  OPT_profile = 1736,                        /* -profile */
  OPT_pthread = 1737,                        /* -pthread */
  OPT_quiet = 1738,                          /* -quiet */
  OPT_r = 1739,                              /* -r */
  OPT_rdynamic = 1740,                       /* -rdynamic */
  OPT_remap = 1741,                          /* -remap */
  OPT_reverse_sort = 1742,                   /* -reverse-sort */
  OPT_s = 1743,                              /* -s */
  OPT_save_temps = 1744,                     /* -save-temps */
  OPT_save_temps_ = 1745,                    /* -save-temps= */
  OPT_shared = 1746,                         /* -shared */
  OPT_shared_libgcc = 1747,                  /* -shared-libgcc */
  OPT_shared_libphobos = 1748,               /* -shared-libphobos */
  OPT_size_sort = 1749,                      /* -size-sort */
  /* OPT_specs = 1750, */                    /* -specs */
  OPT_specs_ = 1751,                         /* -specs= */
  OPT_static = 1752,                         /* -static */
  OPT_static_libasan = 1753,                 /* -static-libasan */
  OPT_static_libgcc = 1754,                  /* -static-libgcc */
  OPT_static_libgfortran = 1755,             /* -static-libgfortran */
  OPT_static_libgo = 1756,                   /* -static-libgo */
  OPT_static_liblsan = 1757,                 /* -static-liblsan */
  OPT_static_libmpx = 1758,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1759,          /* -static-libmpxwrappers */
  OPT_static_libphobos = 1760,               /* -static-libphobos */
  OPT_static_libstdc__ = 1761,               /* -static-libstdc++ */
  OPT_static_libtsan = 1762,                 /* -static-libtsan */
  OPT_static_libubsan = 1763,                /* -static-libubsan */
  OPT_static_pie = 1764,                     /* -static-pie */
  /* OPT_std_c__03 = 1765, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1766, */                /* -std=c++0x */
  OPT_std_c__11 = 1767,                      /* -std=c++11 */
  OPT_std_c__14 = 1768,                      /* -std=c++14 */
  OPT_std_c__17 = 1769,                      /* -std=c++17 */
  /* OPT_std_c__1y = 1770, */                /* -std=c++1y */
  /* OPT_std_c__1z = 1771, */                /* -std=c++1z */
  /* OPT_std_c__20 = 1772, */                /* -std=c++20 */
  OPT_std_c__2a = 1773,                      /* -std=c++2a */
  OPT_std_c__98 = 1774,                      /* -std=c++98 */
  OPT_std_c11 = 1775,                        /* -std=c11 */
  OPT_std_c17 = 1776,                        /* -std=c17 */
  /* OPT_std_c18 = 1777, */                  /* -std=c18 */
  /* OPT_std_c1x = 1778, */                  /* -std=c1x */
  OPT_std_c2x = 1779,                        /* -std=c2x */
  /* OPT_std_c89 = 1780, */                  /* -std=c89 */
  OPT_std_c90 = 1781,                        /* -std=c90 */
  OPT_std_c99 = 1782,                        /* -std=c99 */
  /* OPT_std_c9x = 1783, */                  /* -std=c9x */
  OPT_std_f2003 = 1784,                      /* -std=f2003 */
  OPT_std_f2008 = 1785,                      /* -std=f2008 */
  OPT_std_f2008ts = 1786,                    /* -std=f2008ts */
  OPT_std_f2018 = 1787,                      /* -std=f2018 */
  OPT_std_f95 = 1788,                        /* -std=f95 */
  OPT_std_gnu = 1789,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1790, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1791, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1792,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1793,                    /* -std=gnu++14 */
  OPT_std_gnu__17 = 1794,                    /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1795, */              /* -std=gnu++1y */
  /* OPT_std_gnu__1z = 1796, */              /* -std=gnu++1z */
  /* OPT_std_gnu__20 = 1797, */              /* -std=gnu++20 */
  ...
  OPT_time = 1820,                           /* -time */
  OPT_time_ = 1821,                          /* -time= */
  OPT_tno_android_cc = 1822,                 /* -tno-android-cc */
  OPT_tno_android_ld = 1823,                 /* -tno-android-ld */
