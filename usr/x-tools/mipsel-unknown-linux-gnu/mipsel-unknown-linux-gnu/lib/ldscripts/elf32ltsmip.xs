...
OUTPUT_ARCH(mips)
ENTRY(__start)
SEARCH_DIR("=/home/a.malahov/mips/toolchain/x-tools/mipsel-unknown-linux-gnu/mipsel-unknown-linux-gnu/lib"); SEARCH_DIR("=/usr/local/lib"); SEARCH_DIR("=/lib"); SEARCH_DIR("=/usr/lib");
SECTIONS
{
